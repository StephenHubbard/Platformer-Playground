...
namespace Platformer
{
    public class CameraManager : ValidatedMonoBehaviour
    {
        ...
        {
            input.Look += OnLook;
            input.EnableMouseControlCamera += EnableMouseControlCamera;
            input.DisableMouseControlCamera += DisableMouseControlCamera;
        }
        ...
        void DisableMouseControlCamera()
        {
            isRMBPressed = false;
